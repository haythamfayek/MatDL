function [out, param, cache] = forward_bn_relu(x, w, b, gamma, beta, param)
%FORWARD_BN_RELU Combo forward layer for fully-connected, batchnorm & ReLU layers
%   Inputs:
