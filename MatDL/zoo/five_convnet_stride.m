function [out, grads, opt] = five_convnet_stride(X, model, y, opt)
    ...
    convParam.stride = 2; convParam.pad = 0; convParam.useGPU = opt.useGPU;
    ...
    [a1, bnParam1, cache1] = conv_bn_relu_forward(X, w1, b1, gamma1, beta1, bnParam1, convParam);
    [a2, bnParam2, cache2] = conv_bn_relu_forward(a1, w2, b2, gamma2, beta2, bnParam2, convParam);
    ...
    [da1, dw2, db2, dGamma2, dBeta2] = conv_bn_relu_backward(da2, cache2);
    disp(size(da1))
