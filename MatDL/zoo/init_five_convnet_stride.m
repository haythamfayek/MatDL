function [model, opt] = init_five_convnet_stride(N, K, layersSize, opt)
    ...
    model.w1 = randn(NL1, C, 4, 4) * weightScale;
    model.b1 = randn(1, NL1) * biasScale;
    model.w2 = randn(NL2, NL1, 3, 3) * weightScale;
    model.b2 = randn(1, NL2) * biasScale;
    model.w3 = randn(6 * 6 * NL2, NL3) * weightScale;
